...
export default function AramaCubugu({ aramaMetni, setAramaMetni }) {
    ...
    return (
        <div
            ...
            className="group/arama flex flex-2/3 items-center gap-2 rounded-tl-full bg-[#09080d]/80 py-2 pr-4 pl-6 shadow-md ring-1 ring-white/85 transition-all duration-200 focus-within:ring-[#7a50f5]/70 hover:ring-[#7a50f5]/70"
        >
            <input
                ref={inputRef}
                type="text"
